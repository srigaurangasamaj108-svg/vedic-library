...
The Vedic Library is a long-term civilizational project dedicated to the faithful preservation, structural clarity, and dignified presentation of Vedic and allied śāstric literature.
...
Intellectual humility before tradition

Restraint over feature accumulation
...
Canonical units are determined by:
...
Once canonical text is locked:

It must never be edited

Corrections require a new canonical version

Downstream layers must adapt

7. Separation of Layers
7.1 Mandatory Separation
...
The Vedic Library is not a product.
