...
Status: LOCKED ARCHITECTURAL STANDARDApplies To: All Phase-2+ ingestion sub-projectsAudience: Maintainers, contributors, pipeline authors

0. Purpose of This Document
This document defines the mandatory project-level standard for anycanonical ingestion effort within the Vedic Library.
It answers:
